...
$server_status = $memory_limit >= 268435456 && ( $time_limit >= 180 || $time_limit == 0 );
?>
                ...
                <div id="porto-install-options">
                    ...
                    <div class="porto-install-section" style="margin-bottom: 10px;">
                        <div class="porto-install-options-section" style="display: none;">
                            ...
                            <label for="porto-override-contents"><input type="checkbox" id="porto-override-contents" value="1"/> <?php esc_html_e('Override existing contents', 'porto') ?></label>
                        </div>
                        <p><?php esc_html_e('Do you want to install demo? It can also take a minute to complete.', 'porto') ?></p>
                        <button class="btn btn-primary porto-import-yes"><?php esc_html_e('Standard Import', 'porto') ?></button>
                        ...
                        <button class="btn btn-quaternary porto-import-yes alternative"><?php esc_html_e('Alternative Mode', 'porto') ?></button>
                    </div>
