        ...
        if ( $product->get_date_on_sale_to() ) {
            ...
            echo '<div class="sale-product-daily-deal">';
                ...
                if ( $isSingle ) {
                    ...
                    echo do_shortcode( '[porto_countdown datetime="'. $date_diff .'" countdown_opts="sday,shr,smin,ssec" string_days="Day" string_days2="Days" string_hours=":" string_hours2=":" string_minutes=":" string_minutes2=":" string_seconds="" string_seconds2=""]'. $html .'[/porto_countdown]' );
                }
            echo '</div>';
        }
    }
